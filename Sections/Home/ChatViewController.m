...
//    bgView.image = [UIImage imageNamed:@"chat_bottom_bg"];
    ...
    bgView.layer.borderColor = [UIColor colorWithWhite:0.75 alpha:1.0].CGColor;
    bgView.layer.borderWidth = 0.25;
    bgView.backgroundColor = [UIColor colorWithWhite:1.0 alpha:0.9];
    _toolBar = bgView;
    ...
    [sendSoundBtn setImage:[UIImage imageNamed:@"voiceBtn"] forState:UIControlStateNormal];
    ...
    [addMoreBtn setImage:[UIImage imageNamed:@"picBtn"] forState:UIControlStateNormal];
    ...
    textField.frame = CGRectMake(kToolBarH, (kToolBarH - kTextFieldH) * 0.5, self.view.frame.size.width - 2 * kToolBarH, kTextFieldH);
